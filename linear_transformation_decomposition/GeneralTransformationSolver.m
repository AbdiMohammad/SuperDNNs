function [ S_total, S_stack_total,Transformation_summary, phis_U, thetas_U, phi2_U, phis_V, thetas_V, phi2_V  ] = GeneralTransformationSolver( T )
...
switch unitary_decomposition_method
    case 'Reck'
        [Transformation_matrix_stack_U, phis_U, thetas_U, phi2_U] = ReckDecomposition( U,BStype,simplification ); 
    case 'Clements'
...
switch unitary_decomposition_method
    case 'Reck'
        [Transformation_matrix_stack_V, phis_V, thetas_V, phi2_V] = ReckDecomposition( W,BStype,simplification );
    case 'Clements'
